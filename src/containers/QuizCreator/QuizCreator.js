...
function createOptionControl(number) {
    return createControl({
        ...
        errorMessage: 'Знаение не может быть пустым',
        id: number,
    }, {required: true})
}

function createFormControls(title = '') {
    return {
        title: createControl({
...
class QuizCreator extends Component {
    ...
    addQuestionHandler = event => {
        ...
        this.setState({
            isFormValid: false,
            rightAnswerId: 1,
            formControls: createFormControls(title.value)
        })
    };
    ...
    isCreate = () => {
        if (this.props.message !== '') {
            ...
            return (
                <p style={pStyle}>{this.props.message}</p>
            )
        }
    };
                ...
                <div>
                    ...
                    <form onSubmit={this.submitHandler}>
                        ...
                        <Button
                            ...
                            disabled={this.props.quiz.questions.length === 0 || this.state.formControls.title.value === ''}
                        >
                            Создать тест
                        </Button>
